# -*- coding: utf-8 -*-
"""
Created on Mon Mar  2 16:53:30 2020
...
if __name__ == '__main__':
    ...
    source = plt.imread("../Images/source_07.jpg")
    mask = plt.imread("../Images/mask_07.jpg")
    target = plt.imread("../Images/target_07.jpg")
    ...
    # For high resolution images use an image pyramid for translation
    if source.shape[0] > 3076:
        print(" -- - Multi Scale Approach -- -")
        rShift = image_pyramid(source, target,find_shift)
        print("R channel::    (x, y) Translation: ", rShift)
    
    else:
        print(" -- - Single Scale Approach -- -")
        rShift = find_shift(source[:,:,0], target[:,:,0], x_ref, y_ref, max_range)
        print("R channel::    (x, y) Translation: ", rShift)
